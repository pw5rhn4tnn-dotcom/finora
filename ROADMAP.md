...
Статус: завершенная документационная основа Stage 0; Stage 1–12 не начаты. Это порядок будущих работ, фактическая история находится в [REPORT.md](REPORT.md). Продуктовые правила и приемка — [DISCOVERY.md](DISCOVERY.md), обязательные требования — [PROJECT.md](PROJECT.md), механизмы реализации — [ARCHITECTURE.md](ARCHITECTURE.md).
